...
public class DeviceListAdapterForFindLocation extends ArrayAdapter<String> {
    private final int resourceLayout;
    private final Context mContext;

    public DeviceListAdapterForFindLocation(Context context, int resource, List<String> items) {
